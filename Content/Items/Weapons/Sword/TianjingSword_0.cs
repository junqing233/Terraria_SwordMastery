...
{
    public class TianjingSword_0 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TianjingSword_0Proj>();
            Item.shootSpeed = 1f;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            if (player.altFunctionUse == 2) // 右键射击
            {
                ...
                Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<TianjingSword_0Proj_Right>(), 0, knockback, Main.myPlayer);
                return false;
            }
            else
    ...
    public class TianjingSword_0Proj : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_0Proj";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                for (int i = 0; i < Main.maxProjectiles; i++)
                {
                    ...
                    if (proj.active && proj.owner == Projectile.owner && proj.type == ModContent.ProjectileType<TianjingSword_0Proj_Head>())
                    {
                        hasHead = true;
                        break;
                    }
    ...
    public class TianjingSword_0Proj_Right : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSword_0";
        ...
        public override void AI()
        {
            ...
            if (Main.mouseRight && Owner.HeldItem.type == ModContent.ItemType<TianjingSword_0>())
            {
            ...
            if (foundTower)
            {
                ...
                if (Timer > 60 && Projectile.ai[0] != 1)
                {
                    ...
                    {
                        if (Owner.HeldItem.type == ModContent.ItemType<TianjingSword_0>())
                        {
        ...
        {
            { 6, (ModContent.ItemType<TianjingSword>(), ModContent.ProjectileType<TianjingSwordProj_Right>()) }, // 雪地
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            Texture2D textureToDraw = ModContent.Request<Texture2D>("SwordMastery/Content/Items/Weapons/Sword/TianjingSword_0").Value;
            Player player = Main.player[Projectile.owner];
    ...
    public class TianjingSword_0Proj_Head : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_0Proj_Head";
        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer && Projectile.localAI[0] == 0f)
            {
                ...
                {
                ModContent.ProjectileType<TianjingSword_0Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_0Proj_Body_0>(),
                ModContent.ProjectileType<TianjingSword_0Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_0Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_0Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_0Proj_Body_0>(),
                ModContent.ProjectileType<TianjingSword_0Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_0Proj_Body_2>(),
                ModContent.ProjectileType<TianjingSword_0Proj_Body_3>()
                };
                ...
                int tailType = ModContent.ProjectileType<TianjingSword_0Proj_Tail>();
                Projectile.NewProjectile(
                    Projectile.GetSource_FromAI(),
                    Projectile.Center,
                    Vector2.Zero,
            ...
            if (target == null)
            {
                ...
                Vector2 circlePos = center + new Vector2(
                    280f * (float)Math.Cos(playerCircleT),
                    280f * (float)Math.Sin(playerCircleT)
                );
                // 1. 目标点缓动
            ...
            else
            {
                ...
                float x = 350 * (float)Math.Sin(lemniscateT);
                float y = 350 * (float)Math.Sin(lemniscateT) * (float)Math.Cos(lemniscateT);
        ...
        {
            // 加载头部贴图
            Texture2D texture = ModContent.Request<Texture2D>("SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_0Proj_Head").Value;
    ...
    // 以Body_0为例
    public class TianjingSword_0Proj_Body_0 : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_0Proj_Body_0";
    ...
    // 以Body_1为例
    public class TianjingSword_0Proj_Body_1 : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_0Proj_Body_1";
    ...
    // 以Body_2为例
    public class TianjingSword_0Proj_Body_2 : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_0Proj_Body_2";
    ...
    // 以Body_3为例
    public class TianjingSword_0Proj_Body_3 : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_0Proj_Body_3";
    ...
    public class TianjingSword_0Proj_Tail : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_0Proj_Tail";
    ...
    //雪地晶塔周围插8个火把获得冰雪镜
    public struct TorchToTowerParticleTask
    {
    ...
    public class TianjingSword_0_ : ModSystem
    {
        public override void PostUpdatePlayers()
        {
            foreach (Player player in Main.player)
            {
                ...
                var modPlayer = player.GetModPlayer<TianjingSwordUnlockPlayer>();
                if (modPlayer.HasGotSword) continue;

                Point playerTile = player.Center.ToTileCoordinates();
                int searchRadius = 50; // 玩家周围50格
                for (int x = playerTile.X - searchRadius; x <= playerTile.X + searchRadius; x++)
                {
                    for (int y = playerTile.Y - searchRadius; y <= playerTile.Y + searchRadius; y++)
                    {
                        if (x < 0 || x >= Main.maxTilesX || y < 0 || y >= Main.maxTilesY) continue;
                        Tile tile = Main.tile[x, y];
                        if (tile.TileType == TileID.TeleportationPylon && tile.TileFrameX / 54 == 6)
                        {
                            // 检查火把条件（同你原来的逻辑）
                            int torchCount = 0;
                            List<Point> torchPositions = new();
                            int radius = 10;
                            for (int dx = -radius; dx <= radius; dx++)
                            {
                                for (int dy = -radius; dy <= radius; dy++)
                                {
                                    ...
                                    if (t.TileType == TileID.Torches && t.TileFrameY / 22 == 9 && t.TileFrameX == 0)
                                    {
                                        torchCount++;
                                        torchPositions.Add(new Point(tx, ty));
                                    }
                                }
                            }
                            if (torchCount >= 8)
                            {
                                TrySpawnSword(x, y, torchPositions);
                                return; // 只触发一次
                            }
                        }
                    }
        ...
        private static void TrySpawnSword(int towerX, int towerY, List<Point> torchPositions)
        {
            Vector2 towerPos = new Vector2(towerX * 16 + 24, towerY * 16);
            ...
            foreach (Player player in Main.player)
            {
                ...
                {
                    var modPlayer = player.GetModPlayer<TianjingSwordUnlockPlayer>();
                    if (!modPlayer.HasGotSword)
                    {
                        foreach (var pt in torchPositions)
                        {
                            Vector2 torchPos = new Vector2(pt.X * 16, pt.Y * 16);
                            Vector2 velocity = (towerPos - torchPos);
                            velocity.Normalize();
                            velocity *= 6f; // 粒子速度
                            //for(int i = 0; i < 8; i++)
                            Dust a = Dust.NewDustPerfect(torchPos, DustID.IceTorch, velocity, 150, Color.Cyan, 1.5f);
                            a.fadeIn = 2f;
                            // 设置火把X图格为第4帧
                            Tile torchTile = Main.tile[pt.X, pt.Y];
                            if (torchTile != null && torchTile.TileType == TileID.Torches)
                            {
                                torchTile.TileFrameX = 22 * 3; // 第4帧
                                if (Main.netMode == NetmodeID.Server)
                                    NetMessage.SendTileSquare(-1, pt.X, pt.Y, 1);
                            }
                        }
                        Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(towerX, towerY), towerPos, 3199);
                        modPlayer.HasGotSword = true;
                    }
                }
            }
        }
    }
    public class TianjingSwordUnlockPlayer : ModPlayer
    {
        public bool HasGotSword = false;
        ...
        {
            tag["HasGotSword"] = HasGotSword;
        }

        public override void LoadData(TagCompound tag)
        {
            HasGotSword = tag.GetBool("HasGotSword");
        }
    }
}
