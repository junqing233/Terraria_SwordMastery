...
{
    public class TianjingSword_4 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TianjingSword_4Proj>();
            Item.shootSpeed = 1f;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            if (player.altFunctionUse == 2) // 右键射击
            {
                ...
                Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<TianjingSword_4Proj_Right>(), 0, knockback, Main.myPlayer);
                return false;
            }
            else
    ...
    public class TianjingSword_4Proj : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_4Proj";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                for (int i = 0; i < Main.maxProjectiles; i++)
                {
                    ...
                    if (proj.active && proj.owner == Projectile.owner && proj.type == ModContent.ProjectileType<TianjingSword_4Proj_Head>())
                    {
                        hasHead = true;
                        break;
                    }
    ...
    public class TianjingSword_4Proj_Right : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSword_4";
        ...
        public override void AI()
        {
            ...
            if (Main.mouseRight && Owner.HeldItem.type == ModContent.ItemType<TianjingSword_4>())
            {
            ...
            if (foundTower)
            {
                ...
                if (Timer > 60 && Projectile.ai[0] != 1)
                {
                    ...
                    {
                        if (Owner.HeldItem.type == ModContent.ItemType<TianjingSword_4>())
                        {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            Texture2D textureToDraw = ModContent.Request<Texture2D>("SwordMastery/Content/Items/Weapons/Sword/TianjingSword_4").Value;
            Player player = Main.player[Projectile.owner];
    ...
    public class TianjingSword_4Proj_Head : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_4Proj_Head";
        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer && Projectile.localAI[0] == 0f)
            {
                ...
                {
                ModContent.ProjectileType<TianjingSword_4Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_4Proj_Body_0>(),
                ModContent.ProjectileType<TianjingSword_4Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_4Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_4Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_4Proj_Body_1>(),
                ...
                ModContent.ProjectileType<TianjingSword_4Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_4Proj_Body_1>(),
                ModContent.ProjectileType<TianjingSword_4Proj_Body_2>(),
                ModContent.ProjectileType<TianjingSword_4Proj_Body_3>()
                };
                ...
                int tailType = ModContent.ProjectileType<TianjingSword_4Proj_Tail>();
                Projectile.NewProjectile(
                    Projectile.GetSource_FromAI(),
                    Projectile.Center,
                    Vector2.Zero,
        ...
        {
            // 加载头部贴图
            Texture2D texture = ModContent.Request<Texture2D>("SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_4Proj_Head").Value;
    ...
    // 以Body_0为例
    public class TianjingSword_4Proj_Body_0 : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_4Proj_Body_0";
    ...
    // 以Body_1为例
    public class TianjingSword_4Proj_Body_1 : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_4Proj_Body_1";
    ...
    // 以Body_2为例
    public class TianjingSword_4Proj_Body_2 : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_4Proj_Body_2";
    ...
    // 以Body_3为例
    public class TianjingSword_4Proj_Body_3 : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_4Proj_Body_3";
    ...
    public class TianjingSword_4Proj_Tail : ModProjectile
    {
        public override string Texture => "SwordMastery/Content/Items/Weapons/Sword/TianjingSwordProj/TianjingSword_4Proj_Tail";
