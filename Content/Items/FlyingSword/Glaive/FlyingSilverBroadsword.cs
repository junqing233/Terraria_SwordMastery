...
{
    class FlyingSilverBroadsword : ModItem
    {
        private readonly Texture2D texture = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive/FlyingSilverBroadsword").Value;
        private readonly Texture2D texture_ = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive/FlyingSilverBroadsword_").Value;
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<FlyingSilverBroadswordProj>();
            Item.shootSpeed = 16f;
            Item.buffType = ModContent.BuffType<BuffsFlyingSilverBroadsword>();
        ...
        {
            player.AddBuff(ModContent.BuffType<BuffsFlyingSilverBroadsword>(), 3600);
    ...
    public class FlyingSilverBroadswordProj : ModProjectile
    {
        public override string Texture => GetType().Namespace.Replace(".", "/") + "/FlyingSilverBroadsword";
        public override void SetStaticDefaults()
        {
        ...
        public override bool PreAI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<BuffsFlyingSilverBroadsword>()))
            {
                Projectile.timeLeft = 2;
            }
            if (!player.HasBuff(ModContent.BuffType<BuffsFlyingSilverBroadsword>())) Projectile.Kill();
    ...
    class BuffsFlyingSilverBroadsword : ModBuff
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<FlyingSilverBroadswordProj>()] > 0)//检测玩家持有的弹幕数量
            {
