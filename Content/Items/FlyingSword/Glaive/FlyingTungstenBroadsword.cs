...
{
    class FlyingTungstenBroadsword : ModItem
    {
        private readonly Texture2D texture = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive/FlyingTungstenBroadsword").Value;
        private readonly Texture2D texture_ = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive/FlyingTungstenBroadsword_").Value;
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<FlyingTungstenBroadswordProj>();
            Item.shootSpeed = 16f;
            Item.buffType = ModContent.BuffType<BuffsFlyingTungstenBroadsword>();
        ...
        public override void PostUpdate()
        {
            ...
            //•	G: 221 / 255 ≈ 0.866
            //•	B: 221 / 255 ≈ 0.866
            Lighting.AddLight(Item.Center, 0.866f * intensity, 0.866f * intensity, 0.866f * intensity);
        }
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            player.AddBuff(ModContent.BuffType<BuffsFlyingTungstenBroadsword>(), 3600);
    ...
    public class FlyingTungstenBroadswordProj : ModProjectile
    {
        public override string Texture => GetType().Namespace.Replace(".", "/") + "/FlyingTungstenBroadsword";
        public override void SetStaticDefaults()
        {
        ...
        public override bool PreAI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<BuffsFlyingTungstenBroadsword>()))
            {
                Projectile.timeLeft = 2;
            }
            if (!player.HasBuff(ModContent.BuffType<BuffsFlyingTungstenBroadsword>())) Projectile.Kill();
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color LightsColor = new Color(221, 221, 221);
            var value = (float)(Math.Cos(Main.timeForVisualEffects * 0.04 + Projectile.ai[2] * 0.7) * 0.3f + 0.4f);
            var lig = lightColor.ToVector3().Length() / 1.75f;
    ...
    class BuffsFlyingTungstenBroadsword : ModBuff
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<FlyingTungstenBroadswordProj>()] > 0)//检测玩家持有的弹幕数量
            {
