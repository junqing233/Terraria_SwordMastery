...
{
    class FlyingTerragrim : ModItem
    {
        private readonly Texture2D texture = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive/FlyingTerragrim").Value;
        private readonly Texture2D texture_ = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive/FlyingTerragrim_").Value;
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<FlyingTerragrimProj>();
            Item.shootSpeed = 16f;
            Item.buffType = ModContent.BuffType<BuffsFlyingTerragrim>();
        ...
        public override void PostUpdate()
        {
            ...
            //•	G: 255 / 255 ≈ 1
            //•	B: 206 / 255 ≈ 0.78
            Lighting.AddLight(Item.Center, 0.81f * intensity, 1f * intensity, 0.78f * intensity);
        }
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            player.AddBuff(ModContent.BuffType<BuffsFlyingTerragrim>(), 3600);
    ...
    public class FlyingTerragrimProj : ModProjectile
    {
        public override string Texture => GetType().Namespace.Replace(".", "/") + "/FlyingTerragrim";
        public override void SetStaticDefaults()
        {
        ...
        public override bool PreAI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<BuffsFlyingTerragrim>()))
            {
                Projectile.timeLeft = 2;
            }
            if (!player.HasBuff(ModContent.BuffType<BuffsFlyingTerragrim>())) Projectile.Kill();
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (clown > 0)
                return;
            int projType = ModContent.ProjectileType<FlyingTerragrimProj_>();
            ...
            if (target.CanBeChasedBy(Projectile.owner))
            {
                ...
                spawnPos,
                (target.Center - Projectile.Center).SafeNormalize(Vector2.UnitY) * 0.1f,
                projType,
                damage,
                0f,
                Projectile.owner,
    ...
    public class FlyingTerragrimProj_ : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.localNPCHitCooldown = 5;    // 独立无敌帧时间
        }
        public override void OnSpawn(IEntitySource source)
        {
            Projectile.frame = Main.rand.Next(28);// 随机选择帧
            base.OnSpawn(source);
        }
        public override void AI()
        {
            frameCounter++;
            if (frameCounter >= 1) // 每3tick切换一帧
            {
                frameCounter = 0;
                Projectile.frame++;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color LightsBaneColor = new Color(211, 255, 206);
    ...
    class BuffsFlyingTerragrim : ModBuff
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<FlyingTerragrimProj>()] > 0)//检测玩家持有的弹幕数量
            {
