...
{
    class FlyingPlatinumBroadsword : ModItem
    {
        private readonly Texture2D texture = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive/FlyingPlatinumBroadsword").Value;
        private readonly Texture2D texture_ = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive/FlyingPlatinumBroadsword_").Value;
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<FlyingPlatinumBroadswordProj>();
            Item.shootSpeed = 16f;
            Item.buffType = ModContent.BuffType<BuffsFlyingPlatinumBroadsword>();
        ...
        public override void PostUpdate()
        {
            ...
            //•	G: 228 / 255 ≈ 0.88
            //•	B: 226 / 255 ≈ 0.86
            Lighting.AddLight(Item.Center, 0.89f * intensity, 0.88f * intensity, 0.86f * intensity);
        }
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            player.AddBuff(ModContent.BuffType<BuffsFlyingPlatinumBroadsword>(), 3600);
    ...
    public class FlyingPlatinumBroadswordProj : ModProjectile
    {
        public override string Texture => GetType().Namespace.Replace(".", "/") + "/FlyingPlatinumBroadsword";
        public override void SetStaticDefaults()
        {
        ...
        public override bool PreAI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<BuffsFlyingPlatinumBroadsword>()))
            {
                Projectile.timeLeft = 2;
            }
            if (!player.HasBuff(ModContent.BuffType<BuffsFlyingPlatinumBroadsword>())) Projectile.Kill();
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color LightsColor = new Color(229, 228, 226);
            var value = (float)(Math.Cos(Main.timeForVisualEffects * 0.04 + Projectile.ai[2] * 0.7) * 0.3f + 0.4f);
            var lig = lightColor.ToVector3().Length() / 1.75f;
    ...
    class BuffsFlyingPlatinumBroadsword : ModBuff
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<FlyingPlatinumBroadswordProj>()] > 0)//检测玩家持有的弹幕数量
            {
