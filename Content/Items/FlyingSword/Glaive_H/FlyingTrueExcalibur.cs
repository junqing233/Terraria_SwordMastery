...
{
    class FlyingTrueExcalibur : ModItem
    {
        private readonly Texture2D texture = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive_H/FlyingTrueExcalibur").Value;
        private readonly Texture2D texture_ = ModContent.Request<Texture2D>("SwordMastery/Content/Items/FlyingSword/Glaive_H/FlyingTrueExcalibur_").Value;
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<FlyingTrueExcaliburProj>();
            Item.shootSpeed = 16f;
            Item.buffType = ModContent.BuffType<BuffsFlyingTrueExcalibur>();
        ...
        public override void PostUpdate()
        {
            ...
            //•	G: 105 / 255 ≈ 0.41
            //•	B: 180 / 255 ≈ 0.71
            Lighting.AddLight(Item.Center, 1f * intensity, 0.41f * intensity, 0.71f * intensity);
        }
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            player.AddBuff(ModContent.BuffType<BuffsFlyingTrueExcalibur>(), 3600);
    ...
    public class FlyingTrueExcaliburProj : ModProjectile
    {
        public override string Texture => GetType().Namespace.Replace(".", "/") + "/FlyingTrueExcalibur";
        ...
        public override bool PreAI()
        {
            ...
            {
                if (!player.dead && player.HasBuff(ModContent.BuffType<BuffsFlyingTrueExcalibur>()))
                {
                    Projectile.timeLeft = 2;
                }
                if (!player.HasBuff(ModContent.BuffType<BuffsFlyingTrueExcalibur>())
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (clown > 0)
                return;
            var player = Main.player[Projectile.owner];
            player.GetModPlayer<FlyingTrueExcaliburPlayer>().TrueExcaliburattackspeedTimer = 120;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            // 使用自定义颜色
            Color LightsColor = new Color(255, 105, 180);
    ...
    public class FlyingTrueExcaliburProj_P : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextFloat() * 2.6f < Projectile.Opacity * 0.6f)
            {
                ...
                Color dustColor = Color.Lerp(Color.Pink, Color.White, Main.rand.NextFloat() * 0.3f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(255, 20, 147);
            Color middleMediumColor = new Color(247, 127, 190);
            Color frontLightColor = new Color(246, 173, 198);
    ...
    public class FlyingTrueExcaliburPlayer : ModPlayer
    {
        public int TrueExcaliburattackspeedTimer = 0;

        public override void ResetEffects()
        {
            TrueExcaliburattackspeedTimer = Math.Max(0, TrueExcaliburattackspeedTimer - 1);
        }

        public override void UpdateDead()
        {
            TrueExcaliburattackspeedTimer = 0;
        }
    }
    class BuffsFlyingTrueExcalibur : ModBuff
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<FlyingTrueExcaliburProj>()] > 0)//检测玩家持有的弹幕数量
            {
